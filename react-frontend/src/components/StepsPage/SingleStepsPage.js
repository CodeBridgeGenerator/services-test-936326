...
const SingleStepsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("steps")
            .get(urlParams.singleStepsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
            ...
            ? res.userGuideID.map((elem) => ({ _id: elem._id, serviceName: elem.serviceName }))
            : res.userGuideID
                ? [{ _id: res.userGuideID._id, serviceName: res.userGuideID.serviceName }]
                : [];
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Steps</label><p className="m-0 ml-3" >{_entity?.Steps}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Description</label><p className="m-0 ml-3" >{_entity?.Description}</p></div>
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm">UserGuideID</label>
