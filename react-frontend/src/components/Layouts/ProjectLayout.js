...
import UserGuidePage from "../UserGuidePage/UserGuidePage";
...
<li
                onClick={() => {
                  setCurrentActiveTab2("userGuide");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "userGuide",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "userGuide" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "userGuide",
                      "text-black": props?.currentActiveTab2 !== "userGuide",
                    })}
                  >
                  UserGuide
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "userGuide",
                      "text-yellow-700": props?.currentActiveTab2 !== "userGuide",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("steps");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "steps",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "steps" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "steps",
                      "text-black": props?.currentActiveTab2 !== "steps",
                    })}
                  >
                  Steps
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "steps",
                      "text-yellow-700": props?.currentActiveTab2 !== "steps",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
