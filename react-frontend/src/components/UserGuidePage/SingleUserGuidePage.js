...
const SingleUserGuidePage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("userGuide")
            .get(urlParams.singleUserGuideId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Expiry</label><p id="expiry" className="m-0 ml-3" >{_entity?.expiry}</p></div>
